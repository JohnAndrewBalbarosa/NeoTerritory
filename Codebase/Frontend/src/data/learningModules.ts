...
const PATTERN_THEORY: Record<string, ReadonlyArray<ExamQuestion>> = {
  ...
  factory: [
    ...
    },
    {
      type: 'identification',
      taxonomy: 'understanding',
      question: 'What is the keyword used in C++ to allow a factory method to be overridden in a subclass?',
      scenario: 'You have a Creator base class with a method createProduct(). You want specific subclasses like DocumentCreator and ImageCreator to provide their own product types.',
      expectedTokens: ['virtual'],
      explanation: 'Virtual methods in C++ allow for dynamic dispatch and overriding in subclasses.',
    },
    {
      type: 'studio',
      taxonomy: 'creating',
      prompt: 'Implement a "ShapeFactory" that creates different "Shape" objects (Circle, Square) based on a string input. Use a static method if you prefer a Simple Factory, or an interface for a true Factory Method.',
      targetPatternSlug: 'factory',
      starterCode: 'class Shape {\npublic:\n  virtual ~Shape() = default;\n  virtual void draw() = 0;\n};\n\nclass ShapeFactory {\npublic:\n  // TODO: implement factory logic\n};',
      explanation: 'The student must implement the creation logic that returns polymorphic Shape objects.',
    },
  ],
  'abstract-factory': [
