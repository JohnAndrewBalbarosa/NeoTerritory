...
const ambiguityA: Form = [
  ...
  mk('foundations-ambiguity:A4', 'foundations-ambiguity:B4', 'analyzing', 'analyze', CA, 'difficult',
...
const ambiguityB: Form = [
  ...
  mk('foundations-ambiguity:B4', 'foundations-ambiguity:A4', 'analyzing', 'analyze', CA, 'difficult',
