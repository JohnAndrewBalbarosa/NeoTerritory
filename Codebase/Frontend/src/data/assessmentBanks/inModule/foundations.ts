...
export const IN_MODULE_FOUNDATIONS: InModuleBank = {
  ...
  'foundations-why-matters': [
    imq('remembering', 'why-benefits', 'easy',
      ...
      ['Teams gain a shared vocabulary and code is easier to maintain', 'Code becomes harder to reuse', 'Every class must inherit from one base', 'Builds always run faster'], 0,
    ...
    imq('understanding', 'why-vocabulary', 'moderate',
      ...
      ['It removes the need to compile the code', 'It guarantees the code has no bugs', 'It lets the reviewer grasp the design intent quickly without re-deriving it from scratch', 'It hides the code from other developers'], 2,
  ...
  'foundations-categories': [
    imq('remembering', 'categories-three', 'easy',
      ...
      ['Public, private, protected', 'Easy, moderate, hard', 'Compile, link, run', 'Creational, Structural, Behavioural'], 3,
    ...
    imq('understanding', 'categories-basis', 'moderate',
      ...
      ['By how many lines of code they need', 'By the year they were invented', 'By what the pattern is responsible for — creating objects, organising them, or coordinating behaviour', 'By the author’s last name'], 2,
  ...
  'foundations-oop': [
    ...
    imq('understanding', 'oop-polymorphism-why', 'moderate',
      ...
      ['It makes programs single-threaded', 'It forces every method to be static', 'It removes the need for classes', 'It lets code call a shared interface while different concrete types supply the behaviour'], 3,
  ...
  'foundations-interface-principle': [
    ...
    imq('understanding', 'interface-principle-benefit', 'moderate',
      ...
      ['It deletes all the concrete classes', 'It forces every class to be final', 'It makes the program compile without linking', 'New or swapped implementations can be used without modifying the callers that depend only on the abstraction'], 3,
  ...
  'foundations-code-structure': [
    ...
    imq('understanding', 'code-structure-why', 'moderate',
      ...
      ['Because comments are always wrong', 'Because the compiler renames every class', 'Because class relationships, inheritance, and call flow form recognisable structural arrangements a tool can analyse', 'Because patterns only exist in documentation'], 2,
  ...
  'foundations-real-software': [
    imq('remembering', 'real-software-where', 'easy',
      ...
      ['In production systems written by working engineers across many industries', 'Only in textbooks and university exams', 'Only in code older than 1994', 'Only in single-file programs'], 0,
    ...
    imq('understanding', 'real-software-benefit', 'moderate',
      ...
      ['It lets them skip compiling the project', 'It guarantees the codebase has no bugs', 'It removes the need to talk to teammates ever', 'A recognised pattern conveys a chunk of design intent at once, speeding up comprehension'], 3,
  ...
  'foundations-beginner-mistakes': [
    imq('remembering', 'beginner-mistake-overuse', 'easy',
      ...
      ['Reading the existing code before changing it', 'Naming variables clearly', 'Forcing a pattern where a simple solution would do (over-engineering)', 'Writing unit tests'], 2,
    ...
    imq('understanding', 'beginner-mistake-name', 'moderate',
      ...
      ['Because class names must be lowercase', 'Because patterns cannot be used in named classes', 'Because the compiler ignores names', 'Because a pattern is defined by its structure and intent, not by a label in the name'], 3,
  ...
  'foundations-ambiguity': [
    ...
    imq('understanding', 'ambiguity-why', 'moderate',
      ...
      ['Because tools cannot read C++', 'Because the patterns are secret', 'Because several patterns can share an identical structural shape, so structure alone is insufficient to decide intent', 'Because compilers delete the structure'], 2,
    ...
    imq('applying', 'ambiguity-response', 'moderate',
      ...
      ['Randomly pick one and report it confidently', 'Always choose the alphabetically first pattern', 'Delete the code', 'Report the genuine ambiguity rather than bluffing a single confident answer'], 3,
    ...
    imq('analyzing', 'ambiguity-shared-shape', 'difficult',
      ...
      ['Because forwarding is illegal in C++', 'Because wrapping always means Adapter', 'Because Adapter, Decorator, and Proxy all share that wrap-and-forward shape; intent (convert vs add vs control) must distinguish them', 'Because the classes must be merged'], 2,
    ...
    imq('evaluating', 'ambiguity-judge', 'difficult',
      ...
      ['Trustworthy — high confidence means it is correct', 'Correct because the number is high', 'Correct because Decorator is most common', 'Unjustified — with a shared shape and no disambiguating evidence, a single high-confidence claim is not defensible'], 3,
  ...
  'foundations-connotative-definition': [
    ...
    imq('understanding', 'connotative-set', 'moderate',
      ...
      ['Because one keyword is faster to type', 'Because keywords are banned in C++', 'Because a combination of descriptions narrows which pattern is meant, reducing ambiguity', 'Because patterns have no structure'], 2,
  ...
  'foundations-same-structure': [
    ...
    imq('analyzing', 'same-structure-tiebreak', 'difficult',
      ...
      ['Pick the first candidate alphabetically', 'Ignore both candidates', 'Always report both as 100%', 'Score each candidate per line on intent evidence (lexemes/collaborators) and compare, rather than bluffing'], 3,
  ...
  'foundations-context-variation': [
    imq('remembering', 'context-variation-fact', 'easy',
      ...
      ['write code that looks different while still being Builder', 'write code that always looks byte-for-byte identical', 'never use Builder correctly', 'be forced to use the same variable names'], 0,
