...
// Read-only view of the learner's stored Pre-Test AND Post-Test results for
...
// the dashboard's "View Results" buttons on both the Pre-Test and Post-Test
// cards.
export default function AssessmentResultsPage(): JSX.Element {
        ...
        <div className="nt-test-page__shell">
          <header className="nt-test-page__hero">
            ...
            <p className="nt-test-page__lede">
              {state === 'error'
                ? 'Your saved results could not be loaded. Please try again.'
  ...
  return (
    <main className="nt-test-page" data-testid="assessment-results-page" data-phase="results">
      <div className="nt-test-page__shell">
        <header className="nt-test-page__hero">
          <p className="nt-test-page__eyebrow">Assessment results</p>
          <div className="nt-test-page__badge nt-test-page__badge--alt">CYCLE</div>
          <h1 className="nt-test-page__title">Your Pre-Test &amp; Post-Test Results</h1>
          <p className="nt-test-page__lede">
