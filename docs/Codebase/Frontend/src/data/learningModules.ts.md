...
- `normalizeLearningModule(...)` and `normalizeLearningModules(...)` restore missing taxonomy without shuffling question order.
...
- The runtime catalog exposes all six Bloom levels across its question bank.
