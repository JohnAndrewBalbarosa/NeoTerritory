...
Declares the public interfaces and shared data types for the generic parse and analysis pipeline. It collaborates directly with ParseTree/parse_tree_symbols.hpp.
...
It leans on nearby contracts or tools such as ParseTree/parse_tree_symbols.hpp.
