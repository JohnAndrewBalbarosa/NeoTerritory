...
- Source: Microservice/Modules/Header/SyntacticBrokenAST/Internal/parse_tree_internal.hpp
- Kind: C++ header
- Lines: 6
...
Declares the public interfaces and shared data types for the generic parse and analysis pipeline. It collaborates directly with ParseTree/Internal/parse_tree_internal.hpp.
...
It leans on nearby contracts or tools such as ParseTree/Internal/parse_tree_internal.hpp.
