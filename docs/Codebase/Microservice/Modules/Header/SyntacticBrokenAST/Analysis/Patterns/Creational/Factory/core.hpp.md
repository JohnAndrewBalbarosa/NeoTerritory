...
flowchart TD
    ...
    N2["Declare call"]
    N3["Defer body"]
    N4["Leave build_factory_pattern_tree()"]
    End["End"]
    Start --> N0
    N0 --> N1
    N1 --> N2
...
- build_factory_pattern_tree() (line 13): Declare a callable contract and let implementation files define the runtime body
