...
- Folder: docs/Codebase/Microservice/Modules/Source/SyntacticBrokenAST/ParseTree/Internal
...
- build.cpp.md : Implements parsing, shadow-tree building, symbolization, hash linking, rendering, and reporting.
