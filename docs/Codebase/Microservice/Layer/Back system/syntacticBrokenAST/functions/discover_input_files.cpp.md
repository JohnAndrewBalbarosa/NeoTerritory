...
Inside the body, it mainly handles record derived output into collections, inspect or prepare filesystem paths, assemble tree or artifact structures, and iterate over the active collection.
